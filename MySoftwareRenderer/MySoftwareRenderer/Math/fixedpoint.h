...
namespace fastmath
{
	...
	class FixedPoint : public FixedPointInfo<precision_bits>
	{
		public:
			...
			explicit FixedPoint( float rhs )			: v( (int32_t)( rhs *  (float)ONE + ( rhs < 0 ? -0.5f : 0.5f ) ) ) {}
			explicit FixedPoint( double rhs )			: v( (int32_t)( rhs * (double)ONE + ( rhs < 0 ? -0.5f : 0.5f ) ) ) {}
			...
			inline operator float()								{ return v * ( 1.0f / static_cast<float>( ONE ) ); }
			inline operator double()								{ return v * ( 1.0f / static_cast<double>( ONE ) ); }
			...
			// FixedPoint
			inline bool operator==( const FixedPoint& other )		{ return v == other.v; }
			inline bool operator!=( const FixedPoint& other )		{ return v != other.v; }
			inline bool operator<( const FixedPoint& other )		{ return v  < other.v; }
			inline bool operator>( const FixedPoint& other )		{ return v  > other.v; }
			inline bool operator<=( const FixedPoint& other )		{ return v <= other.v; }
			...
			// int32_t
			inline bool operator==( int32_t other )				{ return v == FixedPoint( other ).v; }
			inline bool operator!=( int32_t other )				{ return v != FixedPoint( other ).v; }
			inline bool operator<( int32_t other )				{ return v  < FixedPoint( other ).v; }
			inline bool operator>( int32_t other )				{ return v  > FixedPoint( other ).v; }
			inline bool operator<=( int32_t other )				{ return v <= FixedPoint( other ).v; }
			...
			// float
			inline bool operator==( float other )				{ return v == FixedPoint( other ).v; }
			inline bool operator!=( float other )				{ return v != FixedPoint( other ).v; }
			inline bool operator<( float other )				{ return v  < FixedPoint( other ).v; }
			inline bool operator>( float other )				{ return v  > FixedPoint( other ).v; }
			inline bool operator<=( float other )				{ return v <= FixedPoint( other ).v; }
			...
			// double
			inline bool operator==( double other )				{ return v == FixedPoint( other ).v; }
			inline bool operator!=( double other )				{ return v != FixedPoint( other ).v; }
			inline bool operator<( double other )				{ return v  < FixedPoint( other ).v; }
			inline bool operator>( double other )				{ return v  > FixedPoint( other ).v; }
			inline bool operator<=( double other )				{ return v <= FixedPoint( other ).v; }
...
*/
	...
	// op: FixedPoint + float
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>
	inline FixedPoint<bits, mulP, divP> operator+( const FixedPoint<bits, mulP, divP>& lhs, float rhs )
	{
		FixedPoint<bits, mulP, divP> result( lhs );
		result += rhs;
		return result;
	...
	// op: float + FixedPoint
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>
	inline FixedPoint<bits, mulP, divP> operator+( float lhs, const FixedPoint<bits, mulP, divP>& rhs )
	{
		return rhs + lhs;
	}
	...
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>
	inline FixedPoint<bits, mulP, divP> operator+( const FixedPoint<bits, mulP, divP>& lhs, double rhs )
	{
		FixedPoint<bits, mulP, divP> result( lhs );
		result += rhs;
		return result;
	...
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>
	inline FixedPoint<bits, mulP, divP> operator+( double lhs, const FixedPoint<bits, mulP, divP>& rhs )
	{
		return rhs + lhs;
	}
	...
	*/
	...
	// FixedPoint
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator==( const FixedPoint<bits, mulP, divP>& lhs, const FixedPoint<bits, mulP, divP>& rhs )	{ return lhs == rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator!=( const FixedPoint<bits, mulP, divP>& lhs, const FixedPoint<bits, mulP, divP>& rhs )	{ return lhs != rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator<( const FixedPoint<bits, mulP, divP>& lhs, const FixedPoint<bits, mulP, divP>& rhs )	{ return lhs  < rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator<=( const FixedPoint<bits, mulP, divP>& lhs, const FixedPoint<bits, mulP, divP>& rhs )	{ return lhs <= rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator>( const FixedPoint<bits, mulP, divP>& lhs, const FixedPoint<bits, mulP, divP>& rhs )	{ return lhs  > rhs;	}
	...
	// int32_t
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator==( int32_t lhs, const FixedPoint<bits, mulP, divP>& rhs )					{ return FixedPoint<bits, mulP, divP>( lhs ) == rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator!=( int32_t lhs, const FixedPoint<bits, mulP, divP>& rhs )					{ return FixedPoint<bits, mulP, divP>( lhs ) != rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator<( int32_t lhs, const FixedPoint<bits, mulP, divP>& rhs )					{ return FixedPoint<bits, mulP, divP>( lhs )  < rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator<=( int32_t lhs, const FixedPoint<bits, mulP, divP>& rhs )					{ return FixedPoint<bits, mulP, divP>( lhs ) <= rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator>( int32_t lhs, const FixedPoint<bits, mulP, divP>& rhs )					{ return FixedPoint<bits, mulP, divP>( lhs )  > rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator>=( int32_t lhs, const FixedPoint<bits, mulP, divP>& rhs )					{ return FixedPoint<bits, mulP, divP>( lhs ) >= rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator==( const FixedPoint<bits, mulP, divP>& lhs, int32_t rhs )					{ return lhs == FixedPoint<bits, mulP, divP>( rhs );	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator!=( const FixedPoint<bits, mulP, divP>& lhs, int32_t rhs )					{ return lhs != FixedPoint<bits, mulP, divP>( rhs );	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator<( const FixedPoint<bits, mulP, divP>& lhs, int32_t rhs )					{ return lhs <  FixedPoint<bits, mulP, divP>( rhs );	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator<=( const FixedPoint<bits, mulP, divP>& lhs, int32_t rhs )					{ return lhs <= FixedPoint<bits, mulP, divP>( rhs );	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator>( const FixedPoint<bits, mulP, divP>& lhs, int32_t rhs )					{ return lhs >  FixedPoint<bits, mulP, divP>( rhs );	}
	...
	// float
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator==( float lhs, const FixedPoint<bits, mulP, divP>& rhs )					{ return FixedPoint<bits, mulP, divP>( lhs ) == rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator!=( float lhs, const FixedPoint<bits, mulP, divP>& rhs )					{ return FixedPoint<bits, mulP, divP>( lhs ) != rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator<( float lhs, const FixedPoint<bits, mulP, divP>& rhs )					{ return FixedPoint<bits, mulP, divP>( lhs )  < rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator<=( float lhs, const FixedPoint<bits, mulP, divP>& rhs )					{ return FixedPoint<bits, mulP, divP>( lhs ) <= rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator>( float lhs, const FixedPoint<bits, mulP, divP>& rhs )					{ return FixedPoint<bits, mulP, divP>( lhs )  > rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator>=( float lhs, const FixedPoint<bits, mulP, divP>& rhs )					{ return FixedPoint<bits, mulP, divP>( lhs ) >= rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator==( const FixedPoint<bits, mulP, divP>& lhs, float rhs )					{ return lhs == FixedPoint<bits, mulP, divP>( rhs );	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator!=( const FixedPoint<bits, mulP, divP>& lhs, float rhs )					{ return lhs != FixedPoint<bits, mulP, divP>( rhs );	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator<( const FixedPoint<bits, mulP, divP>& lhs, float rhs )					{ return lhs <  FixedPoint<bits, mulP, divP>( rhs );	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator<=( const FixedPoint<bits, mulP, divP>& lhs, float rhs )					{ return lhs <= FixedPoint<bits, mulP, divP>( rhs );	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator>( const FixedPoint<bits, mulP, divP>& lhs, float rhs )					{ return lhs >  FixedPoint<bits, mulP, divP>( rhs );	}
	...
	// double
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator==( double lhs, const FixedPoint<bits, mulP, divP>& rhs )				{ return FixedPoint<bits, mulP, divP>( lhs ) == rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator!=( double lhs, const FixedPoint<bits, mulP, divP>& rhs )				{ return FixedPoint<bits, mulP, divP>( lhs ) != rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator<( double lhs, const FixedPoint<bits, mulP, divP>& rhs )					{ return FixedPoint<bits, mulP, divP>( lhs )  < rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator<=( double lhs, const FixedPoint<bits, mulP, divP>& rhs )				{ return FixedPoint<bits, mulP, divP>( lhs ) <= rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator>( double lhs, const FixedPoint<bits, mulP, divP>& rhs )					{ return FixedPoint<bits, mulP, divP>( lhs )  > rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator>=( double lhs, const FixedPoint<bits, mulP, divP>& rhs )				{ return FixedPoint<bits, mulP, divP>( lhs ) >= rhs;	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator==( const FixedPoint<bits, mulP, divP>& lhs, double rhs )				{ return lhs == FixedPoint<bits, mulP, divP>( rhs );	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator!=( const FixedPoint<bits, mulP, divP>& lhs, double rhs )				{ return lhs != FixedPoint<bits, mulP, divP>( rhs );	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator<( const FixedPoint<bits, mulP, divP>& lhs, double rhs )					{ return lhs <  FixedPoint<bits, mulP, divP>( rhs );	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator<=( const FixedPoint<bits, mulP, divP>& lhs, double rhs )				{ return lhs <= FixedPoint<bits, mulP, divP>( rhs );	}
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline bool operator>( const FixedPoint<bits, mulP, divP>& lhs, double rhs )					{ return lhs >  FixedPoint<bits, mulP, divP>( rhs );	}
	...
	// float
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline float& operator+=( float& lhs, const FixedPoint<bits, mulP, divP>& rhs)		{ lhs = (FixedPoint<bits, mulP, divP>)lhs + rhs; return lhs; }
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline float& operator-=( float& lhs, const FixedPoint<bits, mulP, divP>& rhs)		{ lhs = (FixedPoint<bits, mulP, divP>)lhs - rhs; return lhs; }
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline float& operator*=( float& lhs, const FixedPoint<bits, mulP, divP>& rhs)		{ lhs = (FixedPoint<bits, mulP, divP>)lhs * rhs; return lhs; }
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline float& operator/=( float& lhs, const FixedPoint<bits, mulP, divP>& rhs)		{ lhs = (FixedPoint<bits, mulP, divP>)lhs / rhs; return lhs; }

	// double
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline double& operator+=( double& lhs, const FixedPoint<bits, mulP, divP>& rhs)		{ lhs = (FixedPoint<bits, mulP, divP>)lhs + rhs; return lhs; }
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline double& operator-=( double& lhs, const FixedPoint<bits, mulP, divP>& rhs)		{ lhs = (FixedPoint<bits, mulP, divP>)lhs - rhs; return lhs; }
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline double& operator*=( double& lhs, const FixedPoint<bits, mulP, divP>& rhs)		{ lhs = (FixedPoint<bits, mulP, divP>)lhs * rhs; return lhs; }
	template<int32_t bits, template <int32_t> class mulP, template <int32_t> class divP>	inline double& operator/=( double& lhs, const FixedPoint<bits, mulP, divP>& rhs)		{ lhs = (FixedPoint<bits, mulP, divP>)lhs / rhs; return lhs; }
