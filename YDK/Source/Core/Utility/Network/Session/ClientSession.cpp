...
bool CClientSession::SendMsgPack( const SMsg* msg )
{
	if (msg != NULL)
	{
...
SMsg* CClientSession::PopMsgPack()
{
	while (true)
	{
...
bool CClientSession::OnGetData( char* pData, uint32 uiLength )
{
...
void CClientSession::OnPrepareSendData()
{
	while (true)
	{
